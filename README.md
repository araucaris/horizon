...
###### Core
```kotlin
implementation("io.mikeamiry.aegis:aegis:2.0.5")
```

###### Codec (You can create your own, implement io.mikeamiry.aegis.codec.Codec)
```kotlin
implementation("io.mikeamiry.aegis:aegis-codec-fury:2.0.5")
implementation("io.mikeamiry.aegis:aegis-codec-jackson:2.0.5")
```
